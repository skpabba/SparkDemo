...
# This is comma separated list unlike CLASSPATH's which are semi colon separated
export DRIVER_JARS_LIST=/home/cloudera/SparkDemo.jar
...
java com.cloudera.spark.SparkWriteParquet $DRIVER_JARS_LIST spark://clouderavm.localdomain:7077 hdfs://clouderavm.localdomain:8020/user/cloudera/events/events.csv hdfs://clouderavm.localdomain:8020/user/cloudera/events/parquet/
